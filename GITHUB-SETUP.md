...
- After it is enabled and filled in, the app also uploads once per local day when it is open. Nothing uploads if the app is closed. Writing a line never starts an upload.
